...
const CustomToken = rootRequire('./artifacts/examples/evm/cross-benchmark-notary/Notary.sol/Notary.json');
...
async function deploy(chain, wallet) {
    ...
    chain.customToken = await deployContract(wallet, CustomToken, [["0x1016f75c54c607f082ae6b0881fac0abeda21781"]]);
    chain.wallet = wallet;
    const isValid = await chain.customToken.validateTransaction("0x1016f75c54c607f082ae6b0881fac0abeda21781", '0x1016f75c54c607f082ae6b0881fac0abeda21781', 100e6);
